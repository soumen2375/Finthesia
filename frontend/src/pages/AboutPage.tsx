...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white font-sans selection:bg-[#27C4E1] selection:text-white flex flex-col overflow-x-hidden">
      <PublicHeader />

      <main className="flex-grow pt-24 sm:pt-32 pb-16 sm:pb-24">
        
        {/* Header Section */}
        <section className="text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-12 sm:mb-24 relative">
           <div className="absolute top-0 right-0 -translate-y-12 translate-x-1/2 opacity-50 sm:opacity-100">
               <div className="w-64 h-64 sm:w-96 sm:h-96 rounded-full bg-gradient-to-tr from-[#27C4E1]/10 to-transparent blur-3xl -z-10" />
           </div>
          <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold text-slate-900 mb-6 sm:mb-8 tracking-tight px-2">
             Empowering your financial journey, <br className="hidden sm:block"/>
        ...
        {/* Story Section */}
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 sm:mb-24 space-y-12 sm:space-y-16">
           
           <div className="prose prose-base sm:prose-lg prose-slate max-w-none">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 sm:mb-6 font-sans">Who We Are</h2>
           ...
           <div className="prose prose-base sm:prose-lg prose-slate max-w-none">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 sm:mb-6 font-sans">Our Story</h2>
              <p className="text-slate-600 leading-relaxed text-base sm:text-lg">
           ...
           <div className="bg-slate-50 p-6 sm:p-8 rounded-[2rem] sm:rounded-3xl border border-slate-200 shadow-sm mx-auto w-full">
              <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4 font-sans flex items-center gap-3">
                 <Layers className="text-[#27C4E1] w-5 h-5 sm:w-6 sm:h-6 shrink-0" /> Backed by Riknova Technology
              </h2>
              <p className="text-slate-600 leading-relaxed text-base sm:text-lg">
        ...
        <section className="bg-slate-900 py-24 mb-24 relative overflow-hidden">
           ...
           <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              ...
              </div>                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
                  <div className="bg-white/5 border border-slate-700/50 p-6 sm:p-8 rounded-[2rem] sm:rounded-3xl backdrop-blur-sm text-center">
