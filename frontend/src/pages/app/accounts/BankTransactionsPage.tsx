...
import { CSVUploadModal } from '@/components/app/CSVUploadModal';
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center justify-center p-2.5 bg-card border border-border rounded-xl text-text-muted hover:text-text-dark hover:bg-background transition-colors shadow-sm"
            title="Import CSV"
          >
            <Upload size={18} />
          </button>
          <PDFImportButton bankId={bankId} onImported={fetchData} variant="primary" />
        </div>
      </div>
