...
export default function AnalyticsPage() {
  ...
  const colors = ['#2D7FF9', '#7C3AED', '#00C853', '#F59E0B', '#EF4444', '#64748B', '#EC4899', '#8B5CF6'];
          ...
          <section className="card p-8 flex flex-col items-center text-center space-y-4">
            <div className="relative h-48 w-48 flex items-center justify-center">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center space-y-1">
                <span className="text-4xl font-bold text-text-dark">{healthScore}</span>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={monthlyTrendData}>
                    ...
                    <Tooltip 
                      ...
                      formatter={(value: number) => formatCurrency(value, isPrivacyMode)}
                    />
                    <Bar dataKey="income" fill="#2D7FF9" radius={[4, 4, 0, 0]} barSize={12} />
