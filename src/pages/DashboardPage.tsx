    ...
    <div className="space-y-8 pb-12 font-sans tracking-tight">
      ...
      <section className="relative overflow-hidden bg-[#1C1C1E] border border-white/5 rounded-[2.5rem] p-8 md:p-12 text-white shadow-2xl animate-slam">
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          <div className="space-y-4">
            <div className="inline-flex items-center px-4 py-1.5 bg-[#ccff00] text-black text-[10px] font-bold uppercase rounded-full tracking-widest mb-1">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6 animate-slam" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="bg-white p-6 lg:p-8 rounded-[2rem] shadow-xl text-black hover:-translate-y-1 transition-transform group">
          <div className="flex items-center justify-between mb-4">
            <div className="h-16 w-16 bg-[#10b981] text-white rounded-[1.5rem] flex items-center justify-center transition-transform group-hover:scale-110 shadow-lg shadow-[#10b981]/30">
        ...
        <div className="bg-[#8b5cf6] p-6 lg:p-8 rounded-[2rem] shadow-xl text-white hover:-translate-y-1 transition-transform group">
          <div className="flex items-center justify-between mb-4">
            <div className="h-16 w-16 bg-white text-[#8b5cf6] rounded-[1.5rem] flex items-center justify-center transition-transform group-hover:scale-110 shadow-lg">
      ...
      <section className="bg-card p-6 lg:p-8 rounded-[2.5rem] shadow-xl border border-border animate-slam" style={{ animationDelay: '0.2s' }}>
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            <div className="h-12 w-12 bg-[#ccff00] text-black rounded-[1rem] flex items-center justify-center shadow-lg">
              ...
              >
                <div className="flex items-center space-x-5">
                  <div className={cn(
                    ...
                    tx.type === 'income' ? "bg-emerald-100 text-emerald-600" : "bg-[#facc15]/20 text-[#ca8a04]"
                  )}>
                ...
                <div className="text-right">
                  <p className={cn(
                    ...
                    tx.type === 'income' ? "text-[#10b981]" : "text-text-dark"
                  )}>
