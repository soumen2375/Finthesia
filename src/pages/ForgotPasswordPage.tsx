        ...
        >
          ...
          {!isSent ? (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button type="submit" className="w-full bg-[#00696b] hover:bg-[#005a5b] text-white py-3 rounded-xl shadow-lg shadow-[#00696b]/20 transition-all font-semibold" isLoading={isLoading}>
                Send Reset Link
              </Button>
            </form>
          ) : (
          ...
          <div className="flex justify-center pt-6">
            <Link to="/login" className="flex items-center text-sm font-semibold text-[#00696b] hover:text-[#005a5b] hover:underline transition-colors">
