    ...
    <div className="space-y-10 pb-12">
      ...
      <div className="grid grid-cols-1 gap-8">
        {insights.map((insight, i) => (
          <div key={i} className="card p-8 flex flex-col md:flex-row gap-8 items-start group hover:shadow-xl transition-all">
      ...
      <section className="bg-text-dark rounded-[3rem] p-12 text-white relative overflow-hidden shadow-2xl">
        <div className="relative z-10 max-w-lg space-y-8">
          ...
          <button className="px-10 py-4 bg-secondary text-white rounded-2xl font-bold hover:bg-secondary/90 transition-all shadow-lg shadow-secondary/20 active:scale-95">
            Launch Simulator
          </button>
        </div>
